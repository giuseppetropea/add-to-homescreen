...
// message in all supported languages
    ath.intl = {
        ...
        it_it: {
            ...
            android: 'Per aggiungere questa web app alla schermata iniziale, apri il menu opzioni del browser e premi su <strong>Aggiungi alla homescreen</strong>. <small>Puoi accedere al menu premendo il pulsante hardware delle opzioni se il tuo dispositivo ne ha uno, oppure premendo l\'icona %icon in alto a destra.</small>'
        },
    ...
    ath.Class.prototype = {
        ...
        show: function (force) {
            ...
            if ( !this.applicationIcon ) {
                if ( ath.OS == 'ios' ) {
                    this.applicationIcon = document.querySelector('head link[rel^="icon"][sizes="512x512"],head link[rel^=apple-touch-icon][sizes="180x180"],head link[rel^=apple-touch-icon][sizes="152x152"],head link[rel^=apple-touch-icon][sizes="144x144"],head link[rel^=apple-touch-icon][sizes="120x120"],head link[rel^=apple-touch-icon][sizes="114x114"],head link[rel^=apple-touch-icon]');
                } else {
                    this.applicationIcon = document.querySelector('head link[rel^="icon"][sizes="512x512"],head link[rel^="icon"][sizes="192x192"],head link[rel^=apple-touch-icon][sizes="180x180"]');
                }
            }
